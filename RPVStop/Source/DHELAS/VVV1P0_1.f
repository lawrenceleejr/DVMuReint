...
C     
      ...
      TMP6 = (V2(3)*P1(0)-V2(4)*P1(1)-V2(5)*P1(2)-V2(6)*P1(3))
     ...
     $ * W1))
      V1(3)= DENOM*(TMP8*(-CI*(P2(0))+CI*(P3(0)))+(V2(3)*(-CI*(TMP4)
     $ +CI*(TMP5))+V3(3)*(+CI*(TMP6)-CI*(TMP7))))
      V1(4)= DENOM*(TMP8*(-CI*(P2(1))+CI*(P3(1)))+(V2(4)*(-CI*(TMP4)
     $ +CI*(TMP5))+V3(4)*(+CI*(TMP6)-CI*(TMP7))))
      V1(5)= DENOM*(TMP8*(-CI*(P2(2))+CI*(P3(2)))+(V2(5)*(-CI*(TMP4)
     $ +CI*(TMP5))+V3(5)*(+CI*(TMP6)-CI*(TMP7))))
      V1(6)= DENOM*(TMP8*(-CI*(P2(3))+CI*(P3(3)))+(V2(6)*(-CI*(TMP4)
     $ +CI*(TMP5))+V3(6)*(+CI*(TMP6)-CI*(TMP7))))
      END
