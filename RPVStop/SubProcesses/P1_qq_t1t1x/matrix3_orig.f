...
C     Amplitude(s) for diagram number 1
      CALL FFS1_0(W(1,5),W(1,2),W(1,4),GC_710,AMP(1))
      CALL FFS2_2(W(1,1),W(1,3),GC_26,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFS1_0(W(1,5),W(1,2),W(1,4),GC_714,AMP(2))
      CALL FFS2_2(W(1,1),W(1,3),GC_38,MDL_MTA, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFS1_0(W(1,5),W(1,2),W(1,4),GC_718,AMP(3))
      CALL FFS2C1_2(W(1,1),W(1,4),GC_756,MDL_MB, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL FFS1C1_0(W(1,5),W(1,2),W(1,3),GC_56,AMP(4))
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1) = AMP(4)
      JAMP(2,1) = AMP(1)+AMP(2)+AMP(3)+(-1.000000000000000D+00)*AMP(4)
