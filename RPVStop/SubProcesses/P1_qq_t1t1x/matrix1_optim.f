...
C     
C     Process: d d~ > t1 t1~ WEIGHTED<=2 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     & TMP, W, AMP(1,3)) ! count 1
      CALL FFS2_2(W(1,1),W(1,5),GC_14,ZERO, FK_ZERO,W(1,13)) ! count 1
      CALL FFS1_0(W(1,13),W(1,4),W(1,6),GC_698,AMP(1,4)) ! count 1
      CALL FFS2_2(W(1,1),W(1,5),GC_26,ZERO, FK_ZERO,W(1,15)) ! count 1
      CALL FFS1_0(W(1,15),W(1,4),W(1,6),GC_702,AMP(1,5)) ! count 1
      CALL FFS2_2(W(1,1),W(1,5),GC_38,MDL_MTA, FK_ZERO,W(1,17)) ! count 1
      CALL FFS1_0(W(1,17),W(1,4),W(1,6),GC_706,AMP(1,6)) ! count 1
      CALL FFS2C1_2(W(1,1),W(1,6),GC_752,ZERO, FK_ZERO,W(1,19)) ! count 1
      CALL FFS1C1_0(W(1,19),W(1,4),W(1,5),GC_48,AMP(1,7)) ! count 1
      CALL FFS2C1_2(W(1,1),W(1,6),GC_756,MDL_MB, FK_ZERO,W(1,21)) ! count 1
      CALL FFS1C1_0(W(1,21),W(1,4),W(1,5),GC_52,AMP(1,8)) ! count 1
      DO K = 1, NCOMB
