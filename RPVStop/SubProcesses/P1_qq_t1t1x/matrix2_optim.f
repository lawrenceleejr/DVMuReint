...
C     
C     Process: s s~ > t1 t1~ WEIGHTED<=2 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $   *small_width_treatment)), ZERO)
      ...
      CALL OXXXXX(P(0,2),ZERO,-1,-1*IC(2),W(1,4)) ! count 8
      CALL SXXXXX(P(0,3),+1*IC(3),W(1,5)) ! count 11
      CALL SXXXXX(P(0,4),+1*IC(4),W(1,6)) ! count 11
      CALL FFV1P0_3(W(1,1),W(1,4),GC_1,ZERO, FK_ZERO,W(1,7)) ! count 1
      CALL FFV1P0_3(W(1,2),W(1,3),GC_1,ZERO, FK_ZERO,W(1,8)) ! count 1
      CALL VSS1P1N_1(W(1,6), W(1,5), GC_736, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/7,8/),
     & TMP, W, AMP(1,1)) ! count 1
      CALL FFV1P0_3(W(1,1),W(1,4),GC_7,ZERO, FK_ZERO,W(1,9)) ! count 1
      CALL FFV1P0_3(W(1,2),W(1,3),GC_7,ZERO, FK_ZERO,W(1,10)) ! count 1
      CALL VSS1P1N_1(W(1,6), W(1,5), GC_737, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/9,10/),
     & TMP, W, AMP(1,2)) ! count 1
      CALL FFV2_5_3(W(1,1),W(1,4),GC_922,GC_923,MDL_MZ, FK_MDL_WZ,W(1,11)) ! count 1
      CALL FFV2_5_3(W(1,2),W(1,3),GC_922,GC_923,MDL_MZ, FK_MDL_WZ,W(1,12)) ! count 1
      CALL VSS1P1N_1(W(1,6), W(1,5), GC_962, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/11,12/),
     & TMP, W, AMP(1,3)) ! count 1
      CALL FFS2_2(W(1,1),W(1,5),GC_18,ZERO, FK_ZERO,W(1,13)) ! count 1
      CALL FFS1_0(W(1,13),W(1,4),W(1,6),GC_710,AMP(1,4)) ! count 1
      CALL FFS2_2(W(1,1),W(1,5),GC_30,ZERO, FK_ZERO,W(1,15)) ! count 1
      CALL FFS1_0(W(1,15),W(1,4),W(1,6),GC_714,AMP(1,5)) ! count 1
      CALL FFS2_2(W(1,1),W(1,5),GC_42,MDL_MTA, FK_ZERO,W(1,17)) ! count 1
      CALL FFS1_0(W(1,17),W(1,4),W(1,6),GC_718,AMP(1,6)) ! count 1
      CALL FFS2C1_2(W(1,1),W(1,6),GC_752,ZERO, FK_ZERO,W(1,19)) ! count 1
      CALL FFS1C1_0(W(1,19),W(1,4),W(1,5),GC_48,AMP(1,7)) ! count 1
      CALL FFS2C1_2(W(1,1),W(1,6),GC_760,MDL_MB, FK_ZERO,W(1,21)) ! count 1
      CALL FFS1C1_0(W(1,21),W(1,4),W(1,5),GC_56,AMP(1,8)) ! count 1
      DO K = 1, NCOMB
        
        TMP_JAMP(1) = AMP( K,7) +  AMP( K,8)  ! used 2 times
        JAMP(1,1) = AMP( K,1)+(-1.666666666666667D-01)*AMP( K,2)+AMP( K,
     $  3) +TMP_JAMP(1)
        JAMP(2,1) = (5.000000000000000D-01)*AMP( K,2)+AMP( K,4)+AMP( K,5
     $  )+AMP( K,6) +(-1.000000000000000D+00)*TMP_JAMP(1)
