...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFS2_2(W(1,1),W(1,3),GC_14,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL FFS1_0(W(1,5),W(1,2),W(1,4),GC_698,AMP(4))
      CALL FFS2_2(W(1,1),W(1,3),GC_26,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 5
      CALL FFS1_0(W(1,5),W(1,2),W(1,4),GC_702,AMP(5))
      CALL FFS2_2(W(1,1),W(1,3),GC_38,MDL_MTA, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 6
      CALL FFS1_0(W(1,5),W(1,2),W(1,4),GC_706,AMP(6))
      CALL FFS2C1_2(W(1,1),W(1,4),GC_752,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 7
      CALL FFS1C1_0(W(1,5),W(1,2),W(1,3),GC_48,AMP(7))
      CALL FFS2C1_2(W(1,1),W(1,4),GC_756,MDL_MB, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 8
      CALL FFS1C1_0(W(1,5),W(1,2),W(1,3),GC_52,AMP(8))
