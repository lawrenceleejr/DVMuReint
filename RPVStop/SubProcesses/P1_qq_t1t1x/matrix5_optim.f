...
C     ----------
     ...
     $    ABS(mdl_Msu3*small_width_treatment)), mdl_Wsu3)
      ...
      CALL SXXXXX(P(0,3),+1*IC(3),W(1,5)) ! count 6
      CALL SXXXXX(P(0,4),+1*IC(4),W(1,6)) ! count 6
      CALL FFV1P0_3(W(1,1),W(1,4),GC_2,ZERO, FK_ZERO,W(1,7)) ! count 1
      CALL FFV1P0_3(W(1,2),W(1,3),GC_2,ZERO, FK_ZERO,W(1,8)) ! count 1
     ...
     & TMP, W, AMP(1,2)) ! count 1
      CALL FFV2_5_3(W(1,1),W(1,4),GC_921,GC_924,MDL_MZ, FK_MDL_WZ,W(1,11)) ! count 1
      CALL FFV2_5_3(W(1,2),W(1,3),GC_921,GC_924,MDL_MZ, FK_MDL_WZ,W(1,12)) ! count 1
     ...
     $  3)
        JAMP(2,1) = (5.000000000000000D-01)*AMP( K,2)
