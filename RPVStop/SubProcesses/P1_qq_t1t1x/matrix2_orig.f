...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), ZERO)
      ...
      CALL FFV1P0_3(W(1,1),W(1,2),GC_1,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL VSS1_0(W(1,5),W(1,4),W(1,3),GC_736,AMP(1))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_7,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL VSS1_0(W(1,5),W(1,4),W(1,3),GC_737,AMP(2))
      CALL FFV2_5_3(W(1,1),W(1,2),GC_922,GC_923,MDL_MZ, FK_MDL_WZ,W(1
     $ ,5))
C     Amplitude(s) for diagram number 3
      CALL VSS1_0(W(1,5),W(1,4),W(1,3),GC_962,AMP(3))
      CALL FFS2_2(W(1,1),W(1,3),GC_18,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL FFS1_0(W(1,5),W(1,2),W(1,4),GC_710,AMP(4))
      CALL FFS2_2(W(1,1),W(1,3),GC_30,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 5
      CALL FFS1_0(W(1,5),W(1,2),W(1,4),GC_714,AMP(5))
      CALL FFS2_2(W(1,1),W(1,3),GC_42,MDL_MTA, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 6
      CALL FFS1_0(W(1,5),W(1,2),W(1,4),GC_718,AMP(6))
      CALL FFS2C1_2(W(1,1),W(1,4),GC_752,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 7
      CALL FFS1C1_0(W(1,5),W(1,2),W(1,3),GC_48,AMP(7))
      CALL FFS2C1_2(W(1,1),W(1,4),GC_760,MDL_MB, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 8
      CALL FFS1C1_0(W(1,5),W(1,2),W(1,3),GC_56,AMP(8))
C     JAMPs contributing to orders ALL_ORDERS=1
      TMP_JAMP(1) = AMP(7) +  AMP(8)  ! used 2 times
      JAMP(1,1) = AMP(1)+(-1.666666666666667D-01)*AMP(2)+AMP(3)
     $ +TMP_JAMP(1)
      JAMP(2,1) = (5.000000000000000D-01)*AMP(2)+AMP(4)+AMP(5)+AMP(6)
     $ +(-1.000000000000000D+00)*TMP_JAMP(1)
