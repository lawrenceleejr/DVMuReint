...
C     Amplitude(s) for diagram number 1
      CALL VVSS1_0(W(1,1),W(1,2),W(1,4),W(1,3),GC_92,AMP(1))
      CALL VVSS1_0(W(1,1),W(1,2),W(1,4),W(1,3),GC_92,AMP(2))
      CALL VVV1P0_1(W(1,1),W(1,2),GC_6,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL VSS1_0(W(1,5),W(1,4),W(1,3),GC_737,AMP(3))
      CALL VSS1_2(W(1,1),W(1,3),GC_737,MDL_MSU3, ZERO,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL VSS1_0(W(1,2),W(1,4),W(1,5),GC_737,AMP(4))
      CALL VSS1_3(W(1,1),W(1,3),GC_745,MDL_MSU6, ZERO,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL VSS1_0(W(1,2),W(1,4),W(1,5),GC_739,AMP(5))
      CALL VSS1_3(W(1,1),W(1,4),GC_737,MDL_MSU3, ZERO,W(1,5))
C     Amplitude(s) for diagram number 5
      CALL VSS1_0(W(1,2),W(1,5),W(1,3),GC_737,AMP(6))
      CALL VSS1_3(W(1,1),W(1,4),GC_739,MDL_MSU6, ZERO,W(1,5))
C     Amplitude(s) for diagram number 6
      CALL VSS1_0(W(1,2),W(1,3),W(1,5),GC_745,AMP(7))
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1) = AMP(2)+((0.000000000000000D+00,-1.000000000000000D
     $ +00))*AMP(3)+AMP(4)+AMP(5)
      JAMP(2,1) = AMP(1)+((0.000000000000000D+00,1.000000000000000D+00)
     $ )*AMP(3)+AMP(6)+AMP(7)
