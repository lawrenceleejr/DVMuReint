...
C     
C     Process: g g > t1 t1~ WEIGHTED<=2 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $    ABS(mdl_Msu6*small_width_treatment)), mdl_Wsu6)
      ...
      CALL VXXXXX(P(0,2),ZERO,+1,-1*IC(2),W(1,3)) ! count 7
      CALL VXXXXX(P(0,2),ZERO,-1,-1*IC(2),W(1,4)) ! count 7
      CALL SXXXXX(P(0,3),+1*IC(3),W(1,5)) ! count 12
      CALL SXXXXX(P(0,4),+1*IC(4),W(1,6)) ! count 12
      CALL VVSS1_0(W(1,1),W(1,3),W(1,6),W(1,5),GC_92,AMP(4,1))
      CALL VVSS1_0(W(1,2),W(1,4),W(1,6),W(1,5),GC_92,AMP(1,1)) ! count 1
      CALL VVSS1_0(W(1,1),W(1,3),W(1,6),W(1,5),GC_92,AMP(4,2))
      CALL VVSS1_0(W(1,2),W(1,4),W(1,6),W(1,5),GC_92,AMP(1,2)) ! count 1
      CALL VVV1P0_1(W(1,1),W(1,3),GC_6,ZERO, FK_ZERO,W(1,7)) ! count 1
      CALL VVV1P0_1(W(1,2),W(1,4),GC_6,ZERO, FK_ZERO,W(1,10)) ! count 1
      CALL VSS1P1N_1(W(1,6), W(1,5), GC_737, TMP(1))
      call CombineAmp(2,
     & (/4,1/), 
     & (/7,10/),
     & TMP, W, AMP(1,3)) ! count 1
      CALL VSS1_2(W(1,1),W(1,5),GC_737,MDL_MSU3, ZERO,W(1,11)) ! count 2
      CALL VSS1_2(W(1,2),W(1,5),GC_737,MDL_MSU3, ZERO,W(1,12)) ! count 2
      CALL VSS1P1N_1(W(1,6), W(1,11), GC_737, TMP(1))
      call CombineAmp(2,
     & (/4,3/), 
     & (/3,4/),
     & TMP, W, AMP(1,4))
      CALL VSS1P1N_1(W(1,6), W(1,12), GC_737, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/3,4/),
     & TMP, W, AMP(1,4)) ! count 1
      CALL VSS1_3(W(1,1),W(1,6),GC_737,MDL_MSU3, ZERO,W(1,15)) ! count 2
      CALL VSS1_3(W(1,2),W(1,6),GC_737,MDL_MSU3, ZERO,W(1,16)) ! count 2
      CALL VSS1P1N_1(W(1,15), W(1,5), GC_737, TMP(1))
      call CombineAmp(2,
     & (/4,3/), 
     & (/3,4/),
     & TMP, W, AMP(1,6))
      CALL VSS1P1N_1(W(1,16), W(1,5), GC_737, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/3,4/),
     & TMP, W, AMP(1,6)) ! count 1
      DO K = 1, NCOMB
        ...
        JAMP(1,1) = AMP( K,2)+((0.000000000000000D+00,-1.000000000000000
     $  D +00))*AMP( K,3)+AMP( K,4)+AMP( K,5)
        JAMP(2,1) = AMP( K,1)+((0.000000000000000D+00,1.000000000000000D
     $  +00) )*AMP( K,3)+AMP( K,6)+AMP( K,7)
        ...
        IF(SDE_STRAT.EQ.1)THEN
          AMP2(2)=AMP2(2)+AMP( K,3)*DCONJG(AMP( K,3))
          AMP2(3)=AMP2(3)+AMP( K,4)*DCONJG(AMP( K,4))
          AMP2(4)=AMP2(4)+AMP( K,5)*DCONJG(AMP( K,5))
          AMP2(5)=AMP2(5)+AMP( K,6)*DCONJG(AMP( K,6))
          AMP2(6)=AMP2(6)+AMP( K,7)*DCONJG(AMP( K,7))
        ENDIF
